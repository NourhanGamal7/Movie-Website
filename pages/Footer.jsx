            ...
            <div className="container">
                <div className="row gy-4">
                    <div className="col-lg-5 col-md-12 footer-info">
                        ...
                        <p>
                            veritatis dicta fugiat provident. Maxime dignissimos labore nihil 
                            laborum. Esse ab quos quam doloremque repudiandae beatae illo laborum 
                            perspiciatis tempore soluta harum nemo         
                        </p>
